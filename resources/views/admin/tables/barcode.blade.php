...
<body class="min-h-screen flex flex-col items-center justify-center p-6">
    ...
    <!-- POSTER QR CODE -->
    <div
        class="print-card bg-[#1A1A1A] w-full max-w-sm rounded-[50px] overflow-hidden shadow-2xl border border-white/5 relative">
        ...
        <!-- Area QR Code -->
        <div
            class="bg-white m-8 mt-[-20px] p-8 rounded-[40px] shadow-xl flex flex-col items-center justify-center relative z-20">
            <div class="mb-4">
        ...
        <div class="px-10 pb-10 text-center">
            ...
            <div class="p-3 bg-black/40 rounded-2xl border border-white/5">
                <p class="text-[9px] text-slate-500 font-medium leading-relaxed">
                    Silakan scan QR Code di atas untuk melihat menu kami dan melakukan pemesanan langsung dari meja
                    Anda.
                </p>
            </div>
    ...
    <p class="no-print mt-8 text-slate-500 text-xs text-center max-w-xs leading-relaxed">
        <i class="ri-information-line"></i> Tips: Gunakan kertas stiker glossy atau masukkan ke dalam stand tent card
        ukuran A5 agar lebih awet.
    </p>
